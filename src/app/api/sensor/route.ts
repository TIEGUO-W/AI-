...
export async function POST(request: NextRequest) {
  try {
    ...
    const draft: SensorState = {
      ...
      activeEnergy: mergeNumber(body, ['activeEnergy', 'active_energy', 'calories', 'energy', '活动能量', '卡路里']),
      ...
      temp: mergeNumber(body, ['wristTemperature', 'wrist_temperature', 'bodyTemperature', 'body_temperature', 'temp', 'temperature', '手腕温度', '体温', '温度']),
